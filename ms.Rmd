...
format_table_coef_browse_rate_Rmarkdown(table_coef_br_NoUPI, vec_sp)
...
loadd(table_coef_br)
format_table_coef_browse_rate_Rmarkdown_UPI(table_coef_br, vec_sp)
...
loadd(table_coef_gr)
loadd(vec_sp)
format_table_coef_growth_Rmarkdown(table_coef_gr, vec_sp)
```
