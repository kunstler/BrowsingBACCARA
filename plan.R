...
plan <- drake_plan(
   ...
   list_res_br_NoUPI = run_analysis_browsing_rate_NoUPI(df_br, vec_sp),
   coef_br = get_coef_browsing_rate(list_res_br, vec_sp),
   table_coef_br = format_table_coef_br(list_res_br, vec_sp),
   coef_br_NoUPI = get_coef_browsing_rate(list_res_br_NoUPI, vec_sp),
   table_coef_br_NoUPI = format_table_coef_br(list_res_br_NoUPI, vec_sp),
   ...
   list_res_br_NG_NoUPI = run_analysis_browsing_rate_NoUPI(df_br_NG, vec_sp),
   coef_br_NG = get_coef_browsing_rate(list_res_br_NG, vec_sp),
   table_coef_br_NG = format_table_coef_br(list_res_br_NG, vec_sp),
   coef_br_NG_NoUPI = get_coef_browsing_rate(list_res_br_NG_NoUPI, vec_sp),
   table_coef_br_NG_NoUPI = format_table_coef_br(list_res_br_NG_NoUPI, vec_sp),
